            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Piper Neural Engine (100% Offline)',
                      style: GoogleFonts.fredoka(
                        fontSize: 13,
                        fontWeight: FontWeight.w700,
                    ...
                    Text(
                      'On-Device Sherpa-ONNX • Zero server needed',
                      style: GoogleFonts.nunito(
                        fontSize: 10,
                        fontWeight: FontWeight.w600,
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    const CircleAvatar(radius: 3, backgroundColor: Color(0xFF16A34A)),
                    const SizedBox(width: 4),
                    Text(
                      '100% Offline',
                      style: GoogleFonts.nunito(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.record_voice_over_rounded, size: 16, color: Color(0xFF16A34A)),
                    const SizedBox(width: 6),
                    Expanded(
                      child: Text(
                        'On-Device Piper Neural Voices',
